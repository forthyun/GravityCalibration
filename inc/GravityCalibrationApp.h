#ifndef _GRAVITY_CALIBRATION_APP_H_
#define _GRAVITY_CALIBRATION_APP_H_
...
//  The GravityCalibrationApp class must inherit from the UiApp class,
//  which provides the basic features necessary to define a UI application.
 
class GravityCalibrationApp
...
public:
	...
	GravityCalibrationApp(void);
	virtual ~GravityCalibrationApp(void);
...
#endif // _GRAVITY_CALIBRATION_APP_H_
