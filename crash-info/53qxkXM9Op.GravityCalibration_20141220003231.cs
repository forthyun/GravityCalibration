...
PID: 24208
Date: 2014-12-20 00:32:31(GMT+0900)
...
Signal: 11
      (SIGSEGV)
      si_code: -6
      signal sent by tkill (sent by pid 24208, uid 5000)

Register Information
r0   = 0x00000000, r1   = 0x00000007
r2   = 0x00000000, r3   = 0x002569b0
r4   = 0xb26298e4, r5   = 0x0014cca0
r6   = 0x002f3fd8, r7   = 0x0026d398
r8   = 0xbed4fd80, r9   = 0x000a82e0
r10  = 0xb4436940, fp   = 0xbed4fc30
ip   = 0xb6bf4000, sp   = 0xbed4fb88
lr   = 0xb6b39e04, pc   = 0xb2628d24
cpsr = 0x20000010
...
Callstack Information (PID:24208)
Call Stack Count: 42
 0: GravityCalibrationMainForm::Calibration() + 0x2ec (0xb2628d24) [/opt/apps/53qxkXM9Op/bin/GravityCalibration.exe] + 0x6d24
 1: GravityCalibrationMainForm::OnActionPerformed(Tizen::Ui::Control const&, int) + 0xc0 (0xb26298b8) [/opt/apps/53qxkXM9Op/bin/GravityCalibration.exe] + 0x78b8
 2: non-virtual thunk to GravityCalibrationMainForm::OnActionPerformed(Tizen::Ui::Control const&, int) + 0x3c (0xb2629920) [/opt/apps/53qxkXM9Op/bin/GravityCalibration.exe] + 0x7920
End of Call Stack
