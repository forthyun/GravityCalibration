...
PID: 12925
Date: 2014-12-19 19:39:37(GMT+0900)
...
Signal: 11
      (SIGSEGV)
      si_code: -6
      signal sent by tkill (sent by pid 12925, uid 5000)

Register Information
r0   = 0x00000000, r1   = 0xbed4ffb8
r2   = 0x00000000, r3   = 0x00000011
r4   = 0x00288e80, r5   = 0xbed4ffb8
r6   = 0xb264d128, r7   = 0x00000007
r8   = 0xb264d128, r9   = 0xb2625eb0
r10  = 0x5346eca5, fp   = 0xbed500e8
ip   = 0xb37620fd, sp   = 0xbed4fbb0
lr   = 0xb3762105, pc   = 0xb38970cc
cpsr = 0x60000030
...
000dc000 00664000 rw-p [heap]
b25cb000 b25ce000 r-xp /usr/lib/bufmgr/libtbm_exynos4412.so.0.0.0
b25d6000 b25d7000 r-xp /usr/lib/libdrm_slp.so.1.0.0
b25df000 b25e9000 r-xp /usr/lib/evas/modules/engines/software_generic/linux-gnueabi-armv7l-1.7.99/module.so
b2615000 b261e000 r-xp /usr/lib/libcapi-system-sensor.so.0.1.17
b2627000 b2644000 r-xp /usr/lib/osp/libosp-uix.so.1.2.2.0
b264e000 b2657000 r-xp /usr/lib/evas/modules/engines/software_x11/linux-gnueabi-armv7l-1.7.99/module.so
b2660000 b266b000 r-xp /opt/usr/apps/53qxkXM9Op/bin/GravityCalibration.exe
...
Callstack Information (PID:12925)
Call Stack Count: 25
 0: (0xb38970cc) [/usr/lib/osp/libosp-uifw.so] + 0x4a80cc
 1: Tizen::Ui::Controls::Label::SetText(Tizen::Base::String const&) + 0x8 (0xb3762105) [/usr/lib/osp/libosp-uifw.so] + 0x373105
 2: GravityCalibrationMainForm::OnDataReceived(Tizen::Uix::Sensor::SensorType, Tizen::Uix::Sensor::SensorData&, unsigned long) + 0x160 (0xb2666750) [/opt/apps/53qxkXM9Op/bin/GravityCalibration.exe] + 0x6750
 3: non-virtual thunk to GravityCalibrationMainForm::OnDataReceived(Tizen::Uix::Sensor::SensorType, Tizen::Uix::Sensor::SensorData&, unsigned long) + 0x4c (0xb2667ce8) [/opt/apps/53qxkXM9Op/bin/GravityCalibration.exe] + 0x7ce8
End of Call Stack
